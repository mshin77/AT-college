...
reverse_thresholds_alt <- function(data) {
  ...
  coef_labels <- c("intercept (Y>2)", "intercept (Y>3)", "intercept (Y>4)")

    if (length(coef_labels) != 3) {
    stop("coef_labels must have exactly 3 elements.")
  }
